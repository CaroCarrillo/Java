...
public class testPerson {
	...
	try {
		...
		Employee jess = new Employee("Jess", "Hernández", 20, "jess.hernandez@generation.org", "Mentoría",120);
		System.out.println(jess.calculateSalary());
		System.out.println(jess);
		
		
		Manager rufs = new Manager ("Rufino", "Tamayo", 50, "elrufs@gmail.com", "Logística", 1500.0, 20, 0.25f);
		System.out.println(rufs.calculateSalary());
		System.out.println(rufs);
		
		alonso = new Employee ("Alonso", "Grajeda", 15, "alonso.grajeda@generation.org","Mentoría", 150.00);
